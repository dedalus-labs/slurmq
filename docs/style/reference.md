...
> **Tooling Note:** This reference mentions `ruff`, `Black`, and `Pyink`. At Slurmq, we use modern equivalents:
>
> - **Linting/Formatting:** [ruff](https://docs.astral.sh/ruff/) (replaces ruff, Black, isort, Flake8)
> - **Type Checking:** [ty](https://ty.readthedocs.io/) now, [ty](https://github.com/astral-sh/ty) at beta

...
[ty](https://github.com/astral-sh/ty) is Astral's Rust-based type checker. It completes our all-Astral toolchain (uv + ruff + ty) and is 10-100x faster than mypy.
...
| Class    | `PascalCase`          | `QuotaChecker`    |
| Function | `snake_case`          | `fetch_user_jobs` |
...
- [ty documentation](https://github.com/astral-sh/ty) — Type checking
